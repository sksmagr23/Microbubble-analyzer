      ...
      <div className="relative mx-auto max-w-4/5 px-2 py-4 sm:px-1 lg:px-6">
        ...
        <main className="mt-8 grid grid-cols-1 gap-6 xl:grid-cols-2">
          <section className="rounded-3xl border border-cyan-900/60 bg-slate-900/70 p-6 shadow-xl backdrop-blur-xl">
            <h2 className="text-lg font-semibold text-cyan-100">Upload Micrograph</h2>
            <p className="mt-1 text-sm text-slate-300">
              Drop an image or browse your files. Recommended formats: JPG, PNG, TIFF.
            </p>
            ...
            {file && (
              <div className="mt-4 rounded-xl border border-cyan-800/70 bg-cyan-950/25 px-3 py-2 text-xs text-cyan-100">
            ...
            <button
              ...
              disabled={loading}
              className="mt-5 w-full rounded-xl bg-linear-to-r from-emerald-500 to-cyan-500 px-4 py-3 text-sm font-semibold text-slate-950 shadow-lg shadow-emerald-900/30 transition hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-60"
            >
              ...
              <div className="mt-5 rounded-2xl border border-cyan-900/60 bg-slate-800/40 p-4">
                ...
                <div className="mt-3 space-y-3 text-sm">
                  <div className="flex items-center justify-between rounded-xl bg-slate-800/60 px-3 py-2">
                    ...
                    <span className="font-semibold text-emerald-300">{result.count}</span>
                  </div>
                  <div className="flex items-center justify-between rounded-xl bg-slate-800/60 px-3 py-2">
          ...
          <section className="rounded-3xl border border-cyan-900/60 bg-slate-900/70 p-4 shadow-xl backdrop-blur-xl">
            <h2 className="text-lg font-semibold text-cyan-100">Processed Image</h2>
            {result ? (
              <img
                className="mt-4 h-5/6 w-full rounded-2xl border border-cyan-700/60 object-contain"
          ...
          <section className="rounded-3xl border border-cyan-900/60 bg-slate-900/70 p-6 shadow-xl backdrop-blur-xl">
            <h2 className="text-lg font-semibold text-cyan-100">Bubble Size Distribution</h2>
          ...
          <section className="rounded-3xl border border-cyan-900/60 bg-slate-900/70 p-6 shadow-xl backdrop-blur-xl">
            <h2 className="text-lg font-semibold text-cyan-100">Bubble Diameters</h2>
            <div className="mt-4 h-110">
              {result ? (
                <Scatter
                  key={"scatter"}
